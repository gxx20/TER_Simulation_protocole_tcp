...
public class Main {
	public static void main(String[] args) {
		...
		System.out
				.println("Paramètres de transfert : " + totalPacketsRequested + " paquet(s), fenêtre=" + receiveWindow);
	...
	private static int parseArgument(String[] args, int index, int defaultValue) {
		...
		try {
			...
			System.out
					.println("Argument invalide à l'index " + index + ", valeur par défaut utilisée : " + defaultValue);
			return defaultValue;
		}
	}
}