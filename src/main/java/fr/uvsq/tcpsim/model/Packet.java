...
public class Packet {
	...
	/*
	 * Le numéro de séquence est utilisé pour ordonner les paquets et détecter les
	 * pertes
	 */
	...
	public String toString() {
		return "Packet{" + "type=" + type + ", sequenceNumber=" + sequenceNumber + ", acknowledgementNumber="
				+ acknowledgementNumber + ", payload='" + payload + '\'' + ", corrupted=" + corrupted + '}';
	}
}