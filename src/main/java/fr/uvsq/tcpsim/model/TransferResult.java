...
public class TransferResult {
	...
	// Constructeur pour initialiser les paquets envoyés et le nombre de paquets
	// restants
	...
	public String toString() {
		return "TransferResult{" + "sentPackets=" + sentPackets + ", remainingPackets=" + remainingPackets + '}';
	}
}