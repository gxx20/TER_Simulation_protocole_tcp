...
public class TransferSummary {
	...
	public TransferSummary(int requestedPackets, int receivedPackets, int retransmissions, int corruptedPacketsDetected,
			int cycles, int receiveWindow, boolean completed) {
	...
	public String toString() {
		return "TransferSummary{" + "requestedPackets=" + requestedPackets + ", receivedPackets=" + receivedPackets
				+ ", retransmissions=" + retransmissions + ", corruptedPacketsDetected=" + corruptedPacketsDetected
				+ ", cycles=" + cycles + ", receiveWindow=" + receiveWindow + ", completed=" + completed + '}';
	}
	...
	public String toCsvRow() {
		return requestedPackets + "," + receivedPackets + "," + retransmissions + "," + corruptedPacketsDetected + ","
				+ cycles + "," + receiveWindow + "," + completed;
	}
}